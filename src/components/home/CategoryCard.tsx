...
export default function CategoryCard({ category }: CategoryCardProps) {
  ...
  const IconComponent = (() => {
    const icons: Record<string, React.ComponentType<{ className?: string }>> = {
      MapIcon: ({ className }: { className?: string }) => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
        </svg>
      ),
      TruckIcon: ({ className }: { className?: string }) => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      PawPrintIcon: ({ className }: { className?: string }) => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    return icons[category.icon] || icons.MapIcon;
  })();

  return (
    <Link 
      href={`/category/${category.slug}`}
      className="card group p-6 text-center hover:border-primary border-2 border-transparent"
    >
