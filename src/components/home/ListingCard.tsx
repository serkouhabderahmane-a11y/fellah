  ...
  return (
    <Link href={`/listing/${listing.id}`} className="card group">
      <div className="relative h-52 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
        ...
        {listing.featured && (
          <div className="absolute top-3 end-3 z-10 bg-accent text-white text-xs px-3 py-1.5 rounded-full font-medium shadow-lg flex items-center gap-1">
        ...
        <div className="absolute bottom-3 end-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs text-gray-600">
          {listing.createdAt}
        </div>
      </div>
